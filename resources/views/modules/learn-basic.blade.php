...
<head>
    ...
    <title>Huruf Hijaiyah Dasar — Belajar Hijaiyah</title>
...
{{-- ── MAIN ── --}}
<main x-data="hijaiyahCircle({{ json_encode($letters) }})">
    ...
    <div class="text-center pt-8 pb-3 px-4 anim-fade-up">
        ...
        <h1 class="text-2xl lg:text-3xl font-black text-gray-800">Pilih Huruf yang Ingin Dipelajari</h1>
        <p class="text-gray-500 text-sm mt-1.5">Tap salah satu huruf untuk melihat cara membacanya</p>
        {{-- Progress counter --}}
    ...
    <div class="max-w-sm mx-auto px-4 pt-2 pb-10 anim-fade-up d-500">
        <div class="bg-white rounded-3xl border border-teal-100 shadow-sm overflow-hidden">
            <div class="bg-gradient-to-r from-teal-600 to-emerald-500 px-5 py-4 text-center">
                ...
                <p class="text-white font-black text-lg mt-0.5">Siap Belajar Hijaiyah!</p>
            </div>
            <div class="px-5 py-4 flex flex-col items-center">
                <p class="text-gray-400 text-xs mb-3 text-center">Selesaikan modul untuk membuka kuis selanjutnya!</p>
    ...
    >
        ...
        >
            ...
            <div class="px-6 py-5 text-center">
                ...
                {{-- Name --}}
                <div class="text-2xl font-black text-teal-600 mb-5" x-text="selected?.name"></div>
...
<script>
function hijaiyahCircle(letters) {
    return {
        letters,
        selectedIndex: null,
        modalOpen:     false,
